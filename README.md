...
URL del repositorio para el Fronted Web Applications: https://github.com/VeciHub/AplicacionWeb

URL del repositorio para el Backend: https://github.com/VeciHub/vecihub.Api
...
|-|-|
|Marllely Arias|Avancé en los Style Guidelines para establecer una identidad visual mediante el uso de tipografías, colores y otros elementos. Posteriormente, elaboré el diseño de la Landing Page web, para luego explicar los diseños de los prototipos en entornos web, y finalmente realicé la elaboración del diagrama de clases.|
|Javier Nikaido|Durante el desarrollo de esta sección, elaboré los apartados del To Be Scenario Mapping, Impact Mapping, Product Backlog, y Software Configuration Management con todos sus puntos, incluyendo la gestión de código fuente, convenciones de estilo y configuración de despliegue. Además, desarrollé el contenido relacionado con el primer sprint del proyecto, detallando la planificación, el backlog y las evidencias correspondientes|
...
|Luciana Sanchez|Desarrollo de los subpuntos pares del capítulo 4, incluyendo el detalle de la arquitectura de la información, el diseño de la aplicación web (los wireframes y mock-ups en Figma), los diagramas c4 y el diagrama de la base de datos.|
...
|Integrante|Tareas Asignadas|
|-|-|
|Marllely Arias|Apoyo a sus compañeros para la elaboración de los nuevos puntos, organizó el ppt y brindo asistencia en la elaboración del Sprint 2.|
...
|Integrante|Tareas Asignadas|
|-|-|
|Marllely Arias|Desarrollo la migración de las interfaces de incidencia y perfil a Vue para la entrega del sprint 3.|
|Javier Nikaido|Traslado de las pestañas al Fronted de Vue junto al desarrollo de su entrevista pidiendo la opinión de los usuarios acerca de la aplicación.|
...
|Sebastián Hernández|Ajustes y desarrollo de los puntos faltantes del informe, acompañado de la entrevista con respecto a la opinión  de los usuarios.|
...
|-|:-|-|
|Comunica en forma escrita ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerarquicos, en el marco del desarrollo de un proyecto en ingeniería|**Marllely Arias** <br> TB1: Al definir los elementos del "Style Guidelines" de Veichub, comuniqué de manera clara las bases de diseño (assets, tipografías, colores y estilo de comunicación) para que todo el equipo entendiera cómo se mantendría una imagen coherente en los productos web y mobile. <br> <br> TP: <br> **Javier Nikaido** <br> TB1: Durante el desarrollo del proyecto VeciHub, participé elaborando los apartados de To Be Scenario Mapping, Impact Mapping, Product Backlog, Software Configuration Management y el primer Sprint. Redacté los documentos de manera clara, precisa y estructurada, siguiendo siempre las bases establecidas del proyecto. Utilicé un lenguaje técnico apropiado y coherente para asegurar que los avances y resultados fueran comprensibles para todos los involucrados, respetando la jerarquía y especialidad de los distintos públicos objetivo. <br> <br> TP:Para este trabajo hice correcciones, Redacté los documentos de manera clara, precisa y estructurada, siguiendo siempre las bases establecidas del proyecto. <br> **Kael Lagos** <br> TB1: Para el trabajo se hizo la introducción, el planteamiento de la hipotesis, el diseño del logo del proyecto, desarrollo de la conclusión, la inclusión de links a paginas a modo de bibliografía, inclusión de anexos a videos o información complementaria, entrevistas en el sector propietarios y la modificación de ciertos elementos del doc como lo puede ser el cuadro de los integrantes o la estructura inicial del documento para hacerlo más presentable al momento de entregarlo. <br> <br> TP: Considero que cumplí de forma satisfactoria este apartado al realizar distintos cambios al informe con tal de mejorar su estructura y correguir distintos puntos que no quedaron muy bien desarrollados a partir de lo dicho en la retroalimentación anterior. <br> <br> TB2: Este sin duda fue uno de los avances más complicados que se hallan realizado, pues requirio de una completa coordinación con los integrantes del grupo además de resolver los problemas que se presentan por el camino. Por fortuna logramos encontrar una solución a esos contratiempos para cumplir con la entrega. <br> <br> TF: Esta última entrega ciertamente la sentí más tranquila y no tan complicada que la anterior, pues las cosas que se debian añadir o correguir eran muy pocas.<br> **Sebastián Hernández** <br> TB1: En el informe comuniqué de forma clara y objetiva los hallazgos del análisis competitivo, las estrategias frente a competidores y los resultados obtenidos en entrevistas con usuarios y administradores. Además, estructuré el proceso de identificación de necesidades mediante herramientas como User Personas y Journey Mapping, permitiendo que distintos perfiles del equipo comprendan y tomen decisiones informadas en el contexto del proyecto de ingeniería. <br> <br> TP: <br> **Luciana Sanchez** <br> TB1: Para el trabajo se comunicó de forma clara y organizada la arquitectura de la informacion de la aplicacion. De igual forma, el diseño y diagrama de la base de datos a usar. <br> <br> TP: <br> **Adriana Diestra** <br> TB1: Durante las reuniones con los miembros del grupo, mostré una participación activa usando un lenguaje comprensible, participé activamente en las entrevistas a usuarios, interpretando y comunicando los resultados de manera clara y accesible para todos los miembros del equipo. <br> <br> TP: Me aseguré de transmitir mis ideas y resultados de manera clara y concisa, utilizando un lenguaje accesible para todo tipo de audiencias. <br> <br> TB2: Transmití mis ideas y resultados de manera efectiva, adaptando el lenguaje para que fuera comprensible por todos. <br>|<br>**TB1:** En el desarrollo de VeciHub, se comunicaron de manera clara y objetiva los avances junto a los resultados del proyecto a usuarios y stakeholders, asegurando que las funcionalidades de la plataforma cumplieran con las expectativas y necesidades de todos los involucrados.<br> <br>**TP:** Para este nuevo desarrollo del trabajo, se logró coordinar de manera correcta con los integrantes del grupo asegurandose primero de correguir los puntos destacados en la anterior retroalimentación para así avanzar con los nuevos puntos lo más pronto posible tomando en cuenta elementos como el tiempo limite de entrega o la constante supervisión del trabajo para asegurarnos de que cumpla con las nuevas indicaciones.<br> <br> **TB2:** Esta nueva entrega supuso un gran desafio para nosotros como grupo, no habias considerado lo complicado que seria él coordinarnos para encontrar la forma de resolver los problemas que se nos presentaban. Pero logramos perseverar para finalmente cumplir con el nuevo objetivo. <br> <br>**TF:** Para esta última entrega, se pulieron los apartados faltantes pertenecientes al desarrollo del Backend además de su despliegue para su posterior exposición siguiendo las indicaciones dada por el profesor en el documento que sirve como enunciado principal.<br>|
|Comunica oralmente sus ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerarquicos, en el marco del desarrollo de un proyecto en ingeniería.| **Marllely Arias** <br> TB1: En el documento del "Style Guidelines" de Veichub, detallé de forma organizada y comprensible los principios de branding, diseño web y mobile, permitiendo que cualquier miembro del equipo pueda seguir y aplicar las pautas de manera consistente. <br> <br> TP: <br> **Javier Nikaido** <br> TB1: Durante las reuniones de coordinación de VeciHub, expuse de manera oral el progreso de los entregables a mis compañeros y asesores. Expliqué el contenido de los apartados que desarrollé, aclarando dudas técnicas y recibiendo retroalimentación. Mi comunicación fue precisa, adaptándome al nivel de conocimiento de la audiencia, garantizando que los compañeros de equipo comprendieran las decisiones tomadas y los avances del proyecto. <br> <br> TP: Para este trabajo hice correcciones, Redacté los documentos de manera clara, precisa y estructurada, siguiendo siempre las bases establecidas del proyecto. <br> **Kael Lagos** <br> TB1: A lo hora de realizar el trabajo mostró compromiso por arreglar los errores iniciales del informe, brindo indicaciones a sus compañeros para el desarrollo del informe, diseño el logo del proyecto, arregló varios errores en la redacción de los distintos puntos del informe al respetar la enumeración asi como la estructura según las indicaciones dadas y mostró una gran preocupación en todo momento por el estado del informe. <br> <br> TP: Al momento de realizar la nueva entrega consideré los puntos mencionados en la retroalimentacion del TB1 para darles una solución ya sea a nivel de estructura en el contenido, además fui responsable de hacerle saber a mis compañeros los puntos destacados de la retroalimentación acompañado de las indicaciones para lo nuevo que debiamos presentar en esta nueva entrega.<br> <br> TB2: Aprovechando la retroalimentación anterior, me propuse estar todavia más activo con mis compañeros con tal de facilitar algunas partes del informe, así como presentar mi aporte con la entrevista pedida en el último punto según la rúbrica. <br> <br> TF: Para está última entrega logré apoyar al grupo con la edición del video About-the-team en donde mencionabamos las cosas que hemos aprendido a lo largo del curso, además de mostrar nuestro agradecimiento correspondiente al profesor Oscár Ivan por su tutoria. <br> **Sebastián Hernández** <br> TB1: Durante las presentaciones del proyecto, expuse con claridad los resultados del análisis competitivo, las entrevistas realizadas y el proceso de identificación de necesidades, adaptando el lenguaje según el público. Logré transmitir ideas clave a compañeros, docentes y posibles usuarios, facilitando la comprensión de los avances del proyecto VeciHub desde una perspectiva técnica y estratégica. <br> <br> TP: <br> **Luciana Sanchez** <br> TB1: Para la entrega de este trabajo fue necesario detallar la arquitectura de la información para la producción de los wireframes y mock-ups de la aplicación web. <br> <br> TP: <br> **Adriana Diestra** <br> TB1: Durante el desarrollo del trabajo realizó Lean Canvas, una entrevista a usuarios, la construcción de la User Task Matrix, el Journey Mapping, el Empathy Mapping y la creación completa de la Landing Page. <br> <br> TP: En esta segunda entrega, dirigí la implementación del segundo sprint de nuestro proyecto de desarrollo web. Con un enfoque estratégico, planifiqué meticulosamente cada tarea para este período. Durante la reunión de planificación, comuniqué de manera clara y precisa las metas y expectativas del sprint, garantizando que todos en el equipo tuvieran una comprensión común. <br> <br> TB2: Durante el desarrollo del trabajo, realizó la migración de la Landing Page de HTML a Vue.js, estructurándola con componentes reutilizables para mejorar su mantenimiento. Además, llevó a cabo una entrevista a un Administrador de Junta Vecinal. <br> | <br>**TB1:** Como equipo, establecimos canales de comunicación eficaces para entregar el proyecto en los plazos establecidos. Compartimos los resultados con la comunidad y administradores, quienes, a través de entrevistas y reuniones, expresaron su satisfacción con la plataforma. Estas interacciones nos permitieron mejorar el diseño y las funcionalidades de VeciHub, alineándolo con las necesidades de los usuarios.<br> <br>**TP:** Como equipo, consideramos que hemos desarrollado una buena comunicación entre nosotros con tal de completar los puntos faltantes de la nueva entrega y tambien tomabamos la iniciativa de correguir ciertos apartados del informe para luego informarlos por nuestro canal de comunicación permitiendo así que todos estemos al tanto de los cambios hechos al informe.<br> <br> **TB2:** Como equipo, consideramos que el desarrollo de este nuevo avance supuso un reto para la mayoría pues no esperabamos encontrarnos con tantas complicaciones para el nuevo desarrollo. Afortunadamente logramos encontrar la solución a estos problemas y tambien resolvimos los errores que quedaron pendientes de la anterior entrega. <br>**TF:** Como equipo, hemos considera que hemos trabajo muy bien está última parte muy a pesar de ciertas dificultades con algunos integrantes. Pero a pesar de todo, nos las arreglamos para solucionar ese tipo de complicaciones y llevar a cabo una muy buena entrega final que llegué a reflejar nuestro esfuerzo conjunto a lo largo del curso.<br>|
...
<div id='1.3.'><h5> 1.3. Segmentos objetivo</h5></div>
**Vecinos**
...
![Administrador](Imagenes/Captura_EntrevistaMario1.png)
![Administrador](Imagenes/Captura_EntrevistaMario2.png)
...
<div id='4.'><h3>Capítulo IV: Product Design</h3></div>
...
<p align="center">
  <img src="Imagenes/boton1.jpeg" width="300">
</p>
<p align="center">
  <img src="Imagenes/boton2.jpeg" width="300">
</p>
<p align="center">
  <img src="Imagenes/boton3.jpeg" width="300">
</p>
<p align="center">
  <img src="Imagenes/boton4.jpeg" width="300">
</p>
<p align="center">
  <img src="Imagenes/boton5.jpeg" width="300">
</p>
...
![MockUp01](Imagenes/AppWeb/MockUp01.png)
![MockUp02](Imagenes/AppWeb/MockUp02.png)
...
| **Sprint n – 1 Review Summary** | Se desarrolló la landing page a partir de los diseños de wireframe, mockup y prototipo, para luego implementar el código en HTML, CSS. |
| **Sprint n – 1 Retrospective Summary** | Mejorar la organización de las tareas asignadas. |
| Sprint Goal & User Stories |
| **Sprint 1 Goal** | Nuestro enfoque en este sprint es implementar la landing page de nuestro producto. Creemos que esto proporcionará una presentación atractiva y clara, lo cual se confirmará cuando cada sección de la página sea explorada por los usuarios. |
...
Fortaleza: La navegación es intuitiva y los usuarios encuentran lo que buscan con facilidad (anuncios, chats, foros).

Evidencia: “Pudo encontrar todo de manera rápida”; “Visualización de anuncios al entrar a la app”.

Mejora sugerida: Ninguna urgente mencionada, aunque se podría reforzar con notificaciones visuales o indicadores de nuevos mensajes/comunicados.

2. Relación entre el sistema y el mundo real
Fortaleza: Los íconos y botones son fácilmente identificables y claros.

Evidencia: “Botones e íconos amigables y bien diseñados”; “Diseño sencillo pero representativo”.

Mejora sugerida: Si hay funciones como “grupos”, “foros” o “eventos”, podrían tener íconos aún más relacionados con lo cotidiano vecinal (ej. ícono de calendario, vecindario, manos trabajando).

3. Control y libertad del usuario
Fortaleza: Los usuarios no reportaron confusión ni errores al moverse por la app.

Mejora sugerida: Incluir opciones claras para salir de grupos, editar publicaciones, o borrar mensajes daría aún más control. No fue mencionado, pero es parte del buen diseño.

4. Consistencia y estándares
Fortaleza: La interfaz es intuitiva, clara y coherente.

Evidencia: “Todo fue claro y conciso”; “Las secciones están bien identificadas”.

Mejora sugerida: Ninguna urgente. Solo asegurarse de seguir patrones estándar (por ejemplo, íconos de "mensaje" con el globo de chat, etc.).

5. Prevención de errores
Oportunidad de mejora detectada:

“No está muy claro si sus interacciones llegan a ser públicas para todos o solo para el grupo al cual es miembro.”

Esto puede llegar a causar errores o confusión si alguien publica algo personal y resulta visible a toda la comunidad.

Sugerencia a futuro:

Mostrar mensajes de advertencia o confirmación antes de publicar ("¿Estás seguro de que deseas compartir esto con toda la comunidad?" / “Este mensaje será visible solo para tu grupo”).

Agregar íconos o etiquetas que indiquen el alcance de visibilidad.

6. Reconocer antes que recordar
Fortaleza: Todo fue fácil de encontrar y no dependió de la memoria del usuario.

Evidencia: “Todo fue claro y fácil de comprender”; “Las funciones están a pocos clics desde la pantalla principal”.

Mejora sugerida: Continuar manteniendo visibles las funciones más importantes (eventos, foros, anuncios) en la pantalla principal.

7. Flexibilidad y eficiencia de uso
Fortaleza: La app es “muy práctica” y fácil de usar incluso sin explicaciones.

Mejora sugerida: En el futuro, se podría considerar atajos o configuraciones rápidas para usuarios frecuentes (favoritos, fijar grupos, etc.).

8. Estética y diseño minimalista
Fortaleza: “Paleta de colores adecuados y poco engorrosos”; “Diseño sencillo y amigable”.

Evidencia: Usuarios valoran el enfoque visual claro y sin sobrecarga.

Mejora sugerida: Se podría considerar una mejora visual para la sección de eventos.

9. Ayudar a reconocer, diagnosticar y recuperar errores
Oportunidad de mejora: No se mencionaron errores, pero como buena práctica, los mensajes de error (si aparecen) deben ser claros. Ejemplo: “No se pudo enviar el mensaje” vs. “Error 400”.

Sugerencia a futuro: Revisar que todos los errores sean explicativos y amigables.

10. Ayuda y documentación
Fortaleza: Todo fue tan claro que nadie sintió la necesidad de buscar ayuda.

Mejora sugerida a futuro: Un mini tutorial o sección de preguntas frecuentes (FAQ) podría ayudar a nuevos usuarios, sin afectar a quienes ya lo encuentran fácil.
